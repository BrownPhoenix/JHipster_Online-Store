...
import org.jhipster.store.domain.Shipment;
import org.jhipster.store.service.ShipmentService;
...
/**
 * REST controller for managing {@link org.jhipster.store.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")
public class ShipmentResource {
    ...
    public ResponseEntity<List<Shipment>> getAllShipments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
