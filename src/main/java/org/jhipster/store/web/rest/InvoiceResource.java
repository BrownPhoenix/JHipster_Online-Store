...
/**
 * REST controller for managing {@link org.jhipster.store.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceResource {
     ...
     */
    @GetMapping("/invoices")
    public ResponseEntity<List<Invoice>> getAllInvoices(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
